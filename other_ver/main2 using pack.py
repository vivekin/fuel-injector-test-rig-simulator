...
Label(mainframe, text="Select option",font="none 10 bold",bg="black",fg="white").pack()
popupMenu.pack()
Label(mainframe, textvariable = carsel,bg="black",fg="white").pack()
Button(mainframe, text ="Send", command = sendser,bg="white",fg="black").pack()
Label(mainframe, textvariable = serrx,bg="black",fg="white").pack(side = BOTTOM)
