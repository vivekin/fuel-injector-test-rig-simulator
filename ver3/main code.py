...
Label(mainframe, text = "Time(µs)",bg="black",fg="white").grid(row = 4, column = 2)
...
T2 =Text(mainframe, height=1, width=10)
T3 =Text(mainframe, height=1, width=10)
T4 =Text(mainframe, height=1, width=10)
T5 =Text(mainframe, height=1, width=10)
T6 =Text(mainframe, height=1, width=10)
